...
```
0  SMOKE      bank schema and label maps, both prompt templates, arm-B estimator on a
              fixture, metric conventions, client retry                               seconds
...
labelled pool on `gemma-4-31b` if the ladder demands it).
