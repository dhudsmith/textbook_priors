...
environments, resource requests, or running jobs. The project plan is WORKFLOW.md and the concept-bank procedure is CONCEPT_BANK.md; read both
first. WORKFLOW.md section 2 fixes the three hypotheses, their metric and their decision rules:
work that serves none of them belongs in the extensions list, not in `rule all`. TALK.md is the
presentation narrative and constrains nothing.
